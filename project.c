...
void c_month(char *month_name[], int month, int day1, int year){
    ...
    scanf("%d",&choice);
        switch(choice){
            ...
            case 6: {
                    printf("We are Team " ANSI_COLOR_YELLOW "AAKAR" ANSI_COLOR_RESET " from B.tech[IT] 2nd year of MAKAUT, WB.\n\n");
                    printf(ANSI_COLOR_YELLOW "\t\tA" ANSI_COLOR_RESET "bhisek Roy Roll No: 10000219062\n");
                    printf(ANSI_COLOR_YELLOW "\t\tA" ANSI_COLOR_RESET "darsh Gupta Roll No: 10000219061\n");
                    printf(ANSI_COLOR_YELLOW "\t\tK" ANSI_COLOR_RESET "ushal Mitra Roll No: 10000219008\n");
                    printf(ANSI_COLOR_YELLOW "\t\tA" ANSI_COLOR_RESET "nimesh Alok Roll No: 10000219006\n");
                    printf(ANSI_COLOR_YELLOW "\t\tR" ANSI_COLOR_RESET "oni Sikdar  Roll No: 10000219077\n");
...
int main(){
    ...
    SetConsoleTitleA("Calendar by Team AAKAR");
